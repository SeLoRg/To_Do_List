...
async def get_start_page():
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/html/form-login.html"
    )
...
async def get_start_page():
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/html/form-registrate.html"
    )
    response.headers["Cache-Control"] = "no-store, no-cache, must-revalidate, max-age=0"
    response.headers["Pragma"] = "no-cache"
    response.headers["Expires"] = "0"
...
async def get_main_page(cookie=Depends(api_auth.check_access_token)):
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/index.html"
    )
    response.headers["Cache-Control"] = "no-store, no-cache, must-revalidate, max-age=0"
    response.headers["Pragma"] = "no-cache"
    response.headers["Expires"] = "0"
...
async def get_main_page():
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/html/confirm-email.html"
    )
    response.headers["Cache-Control"] = "no-store, no-cache, must-revalidate, max-age=0"
    response.headers["Pragma"] = "no-cache"
    response.headers["Expires"] = "0"
...
async def get_main_page():
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/html/email-send.html"
    )
    response.headers["Cache-Control"] = "no-store, no-cache, must-revalidate, max-age=0"
    response.headers["Pragma"] = "no-cache"
    response.headers["Expires"] = "0"
...
async def get_main_page(token: str):
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/html/email-confirmed.html"
    )
    response.headers["Cache-Control"] = "no-store, no-cache, must-revalidate, max-age=0"
    response.headers["Pragma"] = "no-cache"
    response.headers["Expires"] = "0"
...
async def get_main_page():
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/html/form-password-recovery.html"
    )
    response.headers["Cache-Control"] = "no-store, no-cache, must-revalidate, max-age=0"
    response.headers["Pragma"] = "no-cache"
    response.headers["Expires"] = "0"
...
async def get_main_page(email: str):
    response = FileResponse(
        "C:/Users/rosti/PycharmProjects/FastAPI_DB/To_Do_List/front/html/form-update-password.html"
    )
    response.headers["Cache-Control"] = "no-store, no-cache, must-revalidate, max-age=0"
    response.headers["Pragma"] = "no-cache"
    response.headers["Expires"] = "0"
